...
import static org.example.models.Car.CarCategory.getCategory;
...
public class UserActionServlet extends HttpServlet {
  ...
  private void moveToUser(HttpServletRequest request, HttpServletResponse response)
      throws ServletException {
    forward(AppURL.USER_JSP, request, response);
  }


  private void moveToOrder(HttpServletRequest request, HttpServletResponse response)
      throws ServletException {
    int passengers = Integer.parseInt(request.getParameter("passengers"));
