          ...
          <form id="register-form" name="register-form" action="registration" method="post" onsubmit="return validateForm()" >
            <div class="register-container m-5">
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" placeholder="${firstName}" name="first_name" aria-label="Username" aria-describedby="basic-addon1">
              </div>
              <div class="input-group mb-3">
                <fmt:message key="last_name" var="lastName"/>
                <input type="text" class="form-control" placeholder="${lastName}" name="last_name" aria-label="Username" aria-describedby="basic-addon1">
              </div>
              <div class="input-group mb-3">
                <fmt:message key="email" var="mail"/>
                <input type="e-mail" class="form-control" placeholder="${mail}" name="email"  aria-label="Username" aria-describedby="basic-addon1">
              </div>
              <div class="input-group mb-3">
                <fmt:message key="birthday" var="date_birth"/>
                <input type="date" class="form-control" placeholder="${date_birth}" name="birthday" aria-label="Username" aria-describedby="basic-addon1">
              </div>
              <div class="input-group mb-3">
                <fmt:message key="mobile_phone" var="mobilePhone"/>
                <input type="text" class="form-control" placeholder="${mobilePhone}" name="phone" aria-label="Username" aria-describedby="basic-addon1">
              </div>
              <div class="input-group mb-3">
                <fmt:message key="password" var="_password"/>
                <input type="password" class="form-control" placeholder="${_password}" name="password" id=="password" aria-label="Username" aria-describedby="basic-addon1">
              </div>
              <div class="input-group mb-3">
                <fmt:message key="repeat_password" var="repeatPassword"/>
                <input type="password" class="form-control" placeholder="${repeatPassword}" name="password_check" id=="password_check"  aria-label="Username" aria-describedby="basic-addon1">
              </div>
              ...
              <div class="input-group mb-3">
                <button id="register-submit" type="submit" class="btn btn-primary background-orange-button"><fmt:message key="_submit"/></button>
              </div>
          </form>
